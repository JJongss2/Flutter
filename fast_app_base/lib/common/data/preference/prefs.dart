...
class Prefs {
  ...
  static final isPushOn = PreferenceItem<bool>('isPUshOn', false); // default 값 false
  ...
  static final birthday = RxnPreferenceItem<DateTime, Rxn<DateTime>>('birthday', null); // Rx는 기본적으로 null 불가로 Rxn 사용해야함
  static final number = RxPreferenceItem<int, RxInt>('number', 0); // Rx는 기본적으로 null 불가로 Rxn 사용해야함
